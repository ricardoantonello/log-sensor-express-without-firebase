    ...
    app.get('/temperature/range',function(req, res){
      // Here, the "start" and "end" datetimes for the range of readings are expected to be received through the query parameters.
      // This is spllied as part of the URL request
      const{start, end} = req.query
      // The "fetchReadingsBetweenTime" method is called, which returns an array of results, which we return as
    ...
    /** *** DEFINICOES DE SOCKET *** */

    // Create a new HTTP server that wraps the "app" objectthat defined our server      
    ...
    io.on('connection', socket =>{
        ...
        /* The event listeners are defined inside the callback function because we need to access the "socket"
        * instance, to emit changes to the client. The "pushTemperature" and "pushHumidity" listeners 
        * are called on change of temperature and humidity respectively.
        */
    ...
    /**
     * The httpsServer.listen method is called. This exposes the routes we defined for the "app"
     * instance as well
     */
     ...
     * version is removed, in place of the httpServer.listen  method
     * 
